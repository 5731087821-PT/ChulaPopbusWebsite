...
$(document).ready(function() {	
	...
	$(".map-wrap .route .maximize").on("mouseenter", function() {
		TweenMax.to($(this), 0.3, {autoAlpha: 0.8, ease:Quad.easeOut});
	});
	$(".map-wrap .route .maximize").on("mouseleave click", function() {
		TweenMax.to($(this), 0.3, {autoAlpha: 0.6, ease:Quad.easeOut});
	});
});